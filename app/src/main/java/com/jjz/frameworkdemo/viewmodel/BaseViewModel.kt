...
open class BaseViewModel  : ViewModel() {
     ...
     */
    inline fun <reified T> request(observable : Observable<HttpResult>, crossinline callBack : (T) -> Unit) {
    ...
    inline fun <reified T> requestList(observable : Observable<HttpResult>, crossinline callBack : (ListData<T>) -> Unit) {
        observable.subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
